...
spa.dates = (function () {
  ...
  var
    configMap = {
      main_html: String() + ' <h4 class="datecalc">Date Calculation Region </h4>' + ' <input type="button" class="btn btn-default" value="Show Cemetery View" id="toggleButton" />' + ' <section id="genericDate"></section>' + ' <section id="cemeteryDate"></section>',

      generic_html: String() + '<h3>Generic Date View</h3>' + '<div class="row">' + '<div class="form-group col-md-3 col-xs-8">' + '<label class="control-label" for="startDate">Start</label>'

        + '<input class="form-control" type="date" id="startDate" />' + '<br/>' + '<label class="control-label" for="finishDate">End <b>(Date of interest)</b></label>' + '<input class="form-control finishDate" type="date" />' + '</div>' + '<div class="form-group col-md-3 col-xs-8 col-sm-4">' + '<label class="control-label" for="years">Years </label>' + '<input class="form-control years" type="number" maxlength="3" />' + '<br/>' + '<label class="control-label" for="months">Months</label>' + '<input class="form-control months" type="number" maxlength="2"  />' + '<br/>' + '<div class="form-group col-md-13 col-xs-13">' + '<label class="control-label" for="days">Days </label>' + '<input class="form-control days" type="number" maxlength="2"  />'

        + '<label class="radio-inline" for="radio1">' + '<input class="radio" type="radio" name="gen_whichOp" id="gen_opcode" value="add">Add' + '</label>' + '<br/>' + '<label class="radio-inline" for="radio2">' + '<input class="radio" type="radio" name="gen_whichOp" value="sub" checked>Subtract' + '</label>'

        + '</div>' + '</div>' + '<br/>' + '</div>'

        + '<input type="button" value="Calc" class="btn btn-success btn-lg calcButton" id="calcButton" />' + '<input type="button" value="Clear" class="btn btn-danger btn-lg clearButton" id="clearButton" />' + '<aside class="output">Target:</aside>' + '<br/>',

      cemetery_html: String() + '<h3>Cemetery Date View</h3>' + '<div class="row">' + '<div class="form-group col-md-3 col-xs-8">' + '<label class="control-label" for="finishDate">Death Date</label>' + '<br/>' + '<input type="date" class="form-control finishDate" />' + '</div>'
      ...
      + '<br/>' + '<label class="control-label" for="months">Months</label>'
      + '<input type="number" maxlength="2" class="form-control months" />'
      + '<br/>' + '<div class="form-group col-md-13 col-xs-13">'
      + '<label class="control-label" for="days">Days </label>'
      + '<input type="number" maxlength="2" class="form-control days" />'

        + '<label class="radio-inline" for="radio1">' + '<input type="radio" class="add" name="cem_whichOp" value="add" > Add' + '</label>' + '<br/>' + '<label class="radio-inline" for="radio2">' + '<input type="radio" class="add" name="cem_whichOp" value="sub" id="cem_default" checked> Subtract' + '</label>' + '</div>' + '</div>' + '</div>'



        + '<input type="button" value="Calc" class="btn btn-success btn-lg calcButton" />' + '<input type="button" value="Clear" class="btn btn-danger btn-lg clearButton" />' + '<aside class="output">Target:</aside>' + '<br/>'
    },
